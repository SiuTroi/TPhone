...
const EditUserPage = () => {
  ...
  useEffect(() => {
    get(child(dbRef, `users/${user.userid}/historycheckout`)).then(
      (snapshot) => {
        if (snapshot.exists()) {
        ...
        <div className="pt-12 px-6">
              ...
              <>
                <div className="flex flex-col md:flex-row md:flex-wrap md:gap-2 gap-4 overflow-auto">
                  {historycheckout.map((item) => (
                    <div
                      key={item.id}
                      className="flex flex-col gap-3 shadow-xl bg-white p-8 md:max-w-[49%]"
                    >
                      <div className="flex items-center gap-4">
                        <div className="w-[20%]">
                          <img
          ...
          <div className="mt-10 lg:w-[60%]">
            <div className="flex justify-between items-center">
              ...
              <button
                className="w-[12%] flex justify-center items-center text-[14px] md:w-[82px]"
                onClick={() => {
              ...
              >
                {toggleEdit ? (
                  <span className="underline">Hủy</span>
                ) : (
            ...
            <div>
              {editDone && (
                <p className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-[14px] text-[#7D7D7D] font-semibold">
            ...
            {toggleEdit ? (
              ...
              <>
                <p>
                  Họ tên: <span className="font-light">{user.username}</span>
                </p>
                <p>
